...
## 2.1 Выбор ОС и других параметров для установки Zabbix.
...
## 2.2.3 Распаковываем скачанный репозиторий.
### $dpkg -i zabbix-release_latest_7.4+ubuntu24.04_all.deb
## 2.2.4 Производим обновление.
### $apt update
## 2.2.5 Устанавливаем Zabbix Server, интерфейс, агента.
...
## 1. Скриншот с отображением подлюченых хостов.
...
### 6.1 Клонирование созданой ветки на портале GitHub.
...
### git add README.md
### 6.3 Добавление описания внесённых изменений - commit.
